...
const faqs = [
  ...
  { q: "Quelle est la différence entre Gratuit et Premium ?", a: "Gratuit : deals jusqu'à -29% visibles sur le site. Premium : tous les deals -30% et plus (erreurs de prix, promos flash), alertes Telegram instantanées avec lien de réservation direct Aviasales + Booking. Un seul vol trouvé rembourse votre abonnement." },
  ...
  { q: "Combien ça coûte ?", a: "La formule Gratuite permet de voir les deals jusqu'à -29%. La formule Premium donne accès à tous les deals (-30% et plus, erreurs de prix, alertes Telegram instantanées). Offre printemps : 29€/an au lieu de 59€, soit 2,42€/mois. Satisfait ou remboursé 14 jours. Un seul vol trouvé rembourse votre année." },
      ...
      <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-xl border-b border-gray-100">
        <div className="max-w-6xl mx-auto px-4 md:px-5 h-[64px] flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-6 text-sm text-gray-500">
            ...
            <Link href="/signup" className="hover:text-gray-900 transition-colors">Guides</Link>
